            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button href="{{ url('add_to_cart', $product->id) }}" class="btn btn-primary px-3" onclick="addToCart()"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                            <script>
                               function addToCart(){
                                ciq("track", "AddToCart", {
...
<div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <h6 class="text-primary mb-3"><i class="far fa-clock"></i> {{ $product->created_at->format('Y-m')}}</h6>
                        <h1 class="mb-5">{{$product->title}} product</h1>
                        <p>{{ $product->id }}</p>
                        <p>{{ $product->title }}</p> 

<p><img src="{{ $product->image }}" alt="product Image" width="100" height="100"></p>
...
<ul>
    @foreach ($productsInSameCategory as $cproduct)
        <li>{{ $cproduct->title }}</li>
    @endforeach
</ul>
